...
const englishTextMap = {
  ...
  "КАСАНИЯ": "TOUCHPOINTS",
  "Омар рассматривает апартаменты в JVC. Ключевые критерии — срок сдачи, условия оплаты, бюджет и возможность выбрать 2–3 подходящих объекта перед просмотром.": "Omar is considering apartments in JVC. The key criteria are handover date, payment terms, budget, and the ability to shortlist 2-3 suitable properties before a viewing.",
  "София сравнивает семейные апартаменты в Dubai Marina и Business Bay. Ей нужна компактная подборка с понятными различиями по бюджету, локации и платежному плану.": "Sophia is comparing family apartments in Dubai Marina and Business Bay. She needs a compact shortlist with clear differences in budget, location, and payment plan.",
  "Майкл ищет готовые виллы с приватным садом и спокойным комьюнити для семьи.": "Michael is looking for move-in-ready villas with a private garden in a quiet family community.",
  "Джеймс рассматривает апартаменты для инвестиций и хочет быстро сравнить доходность, район и платежные условия перед выбором объектов для просмотра.": "James is considering investment apartments and wants a quick comparison of yield, area, and payment terms before choosing properties to view.",
  "Эмма подбирает объект для релокации команды. Важны транспортная доступность, готовность объекта и возможность быстро согласовать просмотр.": "Emma is selecting a property for team relocation. Transport access, move-in readiness, and the ability to schedule a viewing quickly are important.",
  "Лиам ищет объект под долгосрочную аренду. Нужно сравнить районы, сервисные сборы и прогнозируемую окупаемость.": "Liam is looking for a property for long-term rental. The neighborhoods, service charges, and projected return need to be compared.",
  "Попросила краткое сравнение двухкомнатных апартаментов с платежным планом и потенциалом перепродажи.": "She asked for a short comparison of two-bedroom apartments with a payment plan and resale potential.",
  "Доброе утро, Омар. Хотел уточнить, удалось ли вам посмотреть варианты, которые я отправлял вчера?": "Good morning, Omar. I wanted to check whether you had a chance to review the options I sent yesterday.",
  "Да, посмотрел. Больше всего заинтересовали семейные апартаменты в Dubai Marina и в Business Bay.": "Yes, I did. I was most interested in the family apartments in Dubai Marina and Business Bay.",
  "Отлично. Подскажите, сейчас для вас важнее бюджет, срок сдачи или потенциальная доходность?": "Great. What matters more to you right now: budget, handover date, or potential return?",
  ...
  "В день срока задачи": "On the due date",
  "За день до срока задачи": "1 day before the due date",
  "Теплый": "Warm",
  "Нецелевой": "Non-target",
  "Закрытый": "Closed",
  "Лид": "Lead",
  "Новый": "New",
  "Без времени": "No time",
  "Клиентов нет": "No clients",
  "Нецелевые": "Non-target",
  "Закрытые": "Closed",
  "Выполненные": "Completed",
  "Запланировать задачу": "Schedule task",
  "ОПИСАНИЕ": "DESCRIPTION",
  "Что нужно сделать": "What needs to be done",
  "Создать задачу": "Create task",
  "Например: что ищет, бюджет, сроки": "For example: what they are looking for, budget, timeline",
  "ДЕТАЛИ": "DETAILS",
  "Создать клиента": "Create client",
  "Сначала старые": "Oldest first",
  "Пропущенные сверху": "Missed first",
  "Назад к звонкам": "Back to calls",
  "Символ ${escapeHtml(key.label)}": "Symbol ${escapeHtml(key.label)}",
  "КЛИЕНТЫ": "CLIENTS",
  "Без компании": "No company",
  "Имя, компания, задача...": "Name, company, task...",
  "Завтра": "Tomorrow",
  "Сегодня, 14:00": "Today, 14:00",
  "Время не указано": "Time not specified",
  "Клиент удален": "Client deleted",
  "Номер клиента находится в списке приватных. Коммуникации не отслеживаются": "This client number is on the private list. Communications are not tracked.",
  "Назад к клиентам": "Back to clients",
  "Смотреть все": "View all",
  "Проанализировать": "Analyze",
  "Добавить вручную": "Add manually",
  "Добавить из CRM": "Add from CRM",
  "Короткое пояснение к полю.": "Short field description.",
  "Контакты": "Contacts",
  "1 клиент": "1 client",
  ...
  "Клиент выбрал два инвестиционных объекта и ждет черновик договора с условиями бронирования и графиком платежей.": "The client selected two investment properties and is waiting for a draft agreement with reservation terms and the payment schedule.",
  "Нужно подтвердить время просмотра и подготовить короткий маршрут по двум объектам рядом с метро.": "You need to confirm the viewing time and prepare a short route between the two properties near the metro.",
  "Клиент получил сравнение районов, сервисных сборов и прогнозируемой окупаемости для долгосрочной аренды.": "The client received a comparison of neighborhoods, service charges, and projected returns for long-term rental.",
  "Уточнили комфортный платежный план и зафиксировали, какие варианты не подходят клиенту.": "You clarified the preferred payment plan and noted which options do not work for the client.",
  "Отправить условия": "Send terms",
  "Запланировать повторный звонок": "Schedule a follow-up call",
  "Подготовить договор бронирования": "Prepare the reservation agreement",
  "Согласовать просмотр апартаментов": "Arrange an apartment viewing",
  "Отправить подборку по районам": "Send the neighborhood shortlist",
  "Уточнить условия оплаты": "Clarify payment terms",
  "Исходящий": "Outgoing",
  "Входящий": "Incoming",
  "Пропущенный": "Missed",
  "Отказ": "Declined",
  ...
  "Гость": "Guest",
  "Идёт разбор входящих обращений": "Reviewing incoming inquiries",
  "Партнёрский QA": "Partner QA",
  "Диалог закрыт": "Conversation closed",
  "Новая заявка с лендинга по подбору квартиры": "New lead from the apartment selection landing page",
  "Заявка SuperBroker": "SuperBroker lead",
  "Клиент ждёт обратный звонок": "The client is waiting for a callback",
  "Отметили, что перед бронированием просмотров нужно согласовать варианты с супругом.": "It was noted that the options need to be aligned with the spouse before booking viewings.",
  "Пытались связаться после отправки вариантов вилл; ответа нет, сегодня нужен повторный контакт.": "You tried to reach out after sending the villa options; there was no response, so a follow-up contact is needed today.",
  "Подборка вилл отправлена": "Villa shortlist sent",
  "Отправили три варианта в Arabian Ranches и спросили, какие объекты поставить в приоритет для просмотра.": "Three options in Arabian Ranches were sent, and you asked which properties should be prioritized for viewing.",
  "Клиент попросил подготовить несколько ликвидных объектов с понятной ожидаемой доходностью.": "The client asked for several liquid properties with a clear expected return.",
  "Критерии клиента уточнены": "Client criteria clarified",
  "Добавили требования к району, сроку готовности и удобству для ежедневных поездок.": "Requirements for the area, readiness date, and commuting convenience were added.",
  "Вводный звонок": "Introductory call",
  "Обсудили инвестиционный горизонт, желаемый район и комфортный диапазон бюджета.": "You discussed the investment horizon, preferred area, and comfortable budget range.",
  "Нужно уточнить желаемый срок сдачи объекта и предпочтительные условия оплаты. Подтвердить бюджетный диапазон и гибкость бюджета. Сравнить 2–3 подходящих строящихся объекта в JVC.": "You need to clarify the preferred handover date and payment terms. Confirm the budget range and flexibility. Compare 2-3 suitable off-plan properties in JVC.",
  "Подтвердить удобные дату и время просмотра, затем зафиксировать договоренность в карточке клиента.": "Confirm a convenient viewing date and time, then record the agreement in the client card.",
  "Повторный звонок": "Follow-up call",
  "Уточнили, что сроки сдачи и гибкость платежного плана важны перед записью на просмотр.": "It was clarified that handover dates and payment plan flexibility are important before booking a viewing.",
  "Проверка времени для просмотра": "Viewing time check",
  "Запросили удобные даты и временные окна, чтобы организовать просмотр объекта.": "Convenient dates and time windows were requested to organize the property viewing.",
  "Подборка проектов отправлена": "Project shortlist sent",
  "Отправили короткий список строящихся апартаментов в JVC под бюджет и ожидания по срокам переезда.": "A short list of off-plan apartments in JVC matching the budget and move-in timeline was sent.",
  "Условия подготовлены": "Terms prepared",
  "Черновик сообщения по объектам и условиям оплаты готов к отправке клиенту.": "The draft message with property details and payment terms is ready to send to the client.",
  "Контекст подтвержден": "Context confirmed",
  "Подтвердили бюджет, район и ожидания по сроку сдачи объекта.": "The budget, area, and expected handover timeline were confirmed.",
  "Подготовить подборку": "Prepare shortlist",
  "София выбирает между двухкомнатными апартаментами в Dubai Marina и Business Bay. Ей нужна короткая подборка без лишних вариантов, чтобы быстро согласовать бюджет с семьей.": "Sophia is choosing between two-bedroom apartments in Dubai Marina and Business Bay. She needs a short shortlist without extra options so she can quickly align the budget with her family.",
  "Собрать 3–4 объекта до AED 3,5M с понятной сравнительной таблицей: район, площадь, вид, платежный план, сервисные сборы и ожидаемая доходность.": "Prepare 3-4 properties up to AED 3.5M with a clear comparison table: area, size, view, payment plan, service charges, and expected yield.",
  "Отправить предложение в мессенджер и назначить повторный контакт на следующий день, если клиент откроет материалы, но не ответит.": "Send the proposal in a messenger and schedule a follow-up for the next day if the client opens the materials but does not reply.",
  "София смотрит инвестиционные апартаменты для семьи. Важны ликвидный район, понятный платежный план и возможность быстро выйти на просмотр лучших вариантов.": "Sophia is reviewing investment apartments for her family. A liquid area, a clear payment plan, and the ability to quickly view the best options are important.",
  "Квалификационный звонок": "Qualification call",
  "Подтвердили целевой бюджет, предпочтительные районы и необходимость компактного сравнения инвестиций.": "The target budget, preferred areas, and the need for a compact investment comparison were confirmed.",
  "Критерии покупателя обновлены": "Buyer criteria updated",
  "Отметили Dubai Marina и Business Bay как приоритетные районы и добавили согласование с семьей как этап решения.": "Dubai Marina and Business Bay were marked as priority areas, and family approval was added as a decision stage.",
  "Первые варианты обсуждены": "Initial options reviewed",
  "Отправили два примера, чтобы сверить ожидания перед подготовкой финального предложения.": "Two examples were sent to align expectations before preparing the final proposal.",
  "Позвонить клиенту": "Call client",
  "Майкл ищет виллу для переезда семьи. Главные факторы — приватность, готовность объекта, сад и спокойное комьюнити с хорошей транспортной доступностью.": "Michael is looking for a villa for his family's relocation. The key factors are privacy, move-in readiness, a garden, and a quiet community with good transport access.",
  "Семейные требования зафиксированы": "Family requirements recorded",
  "Добавили приватный сад, готовность к заселению и спокойное комьюнити как обязательные фильтры.": "A private garden, move-in readiness, and a quiet community were added as mandatory filters.",
  "Джеймс выбрал два инвестиционных объекта и хочет сравнить условия бронирования перед финальным решением.": "James selected two investment properties and wants to compare booking terms before the final decision.",
  "Подготовить черновик договора, график платежей и короткое сравнение обязательных платежей по каждому объекту.": "Prepare a draft agreement, payment schedule, and a short comparison of mandatory payments for each property.",
  "После отправки зафиксировать вопросы клиента и назначить следующий контакт для согласования брони.": "After sending, record the client's questions and schedule the next contact to align on the reservation.",
  "Джеймс рассматривает апартаменты для инвестиций. Ему важно быстро сравнить доходность, район и платежные условия перед выбором объекта.": "James is considering apartments for investment. It is important for him to quickly compare yield, area, and payment terms before choosing a property.",
  "Уточнили формат документов": "Document format clarified",
  "Клиент попросил подготовить договор и график платежей в одном сообщении.": "The client asked for the agreement and payment schedule in one message.",
  "Объекты выбраны": "Properties selected",
  "В финальном сравнении остались два объекта с похожим бюджетом и разными сроками оплаты.": "The final comparison now includes two properties with a similar budget and different payment schedules.",
  "Джеймс попросил прислать условия бронирования и список платежей.": "James asked to receive the reservation terms and payment list.",
  "Эмма подбирает объект для релокации команды. Нужен просмотр двух апартаментов рядом с метро и понятный маршрут между объектами.": "Emma is selecting a property for team relocation. She needs a viewing of two apartments near the metro and a clear route between them.",
  "Подтвердить время с клиентом и владельцами объектов, проверить доступность парковки и подготовить краткую карточку каждого варианта.": "Confirm the time with the client and property owners, check parking availability, and prepare a brief card for each option.",
  "После просмотра зафиксировать обратную связь и следующий шаг по выбранному объекту.": "After the viewing, record the feedback and the next step for the selected property.",
  "Время согласовано предварительно": "Time tentatively confirmed",
  "Клиенту подходит пятница после 16:00, осталось подтвердить доступность объектов.": "Friday after 16:00 works for the client; you only need to confirm property availability.",
  "Маршрут просмотра подготовлен": "Viewing route prepared",
  "Выбрали два объекта рядом с метро, чтобы уложиться в один выезд.": "Two properties near the metro were selected to fit into a single trip.",
  "Критерии отправлены": "Criteria sent",
  "Эмма уточнила требования к району, парковке и готовности объекта.": "Emma clarified the requirements for the area, parking, and property readiness.",
  "Лиам получил подборку районов для долгосрочной аренды и сравнение сервисных сборов по каждому варианту.": "Liam received a shortlist of neighborhoods for long-term rental and a comparison of service charges for each option.",
  "В задаче зафиксированы районы с лучшим соотношением бюджета, транспортной доступности и прогнозируемой окупаемости.": "The task records the areas with the best mix of budget, transport access, and projected return.",
  "Следующий шаг — дождаться обратной связи клиента и при необходимости создать новую задачу на просмотр.": "The next step is to wait for the client's feedback and create a new viewing task if needed.",
  "Лиам ищет объект под долгосрочную аренду. Для него важны район, сервисные сборы и понятная окупаемость.": "Liam is looking for a property for long-term rental. The area, service charges, and clear returns are important for him.",
  "Результат согласован": "Result aligned",
  "Клиент подтвердил, что подборка закрывает первый этап сравнения районов.": "The client confirmed that the shortlist covers the first stage of comparing neighborhoods.",
  "Критерии обновлены": "Criteria updated",
  "Добавили сервисные сборы и прогнозируемую доходность как обязательные параметры.": "Service charges and projected yield were added as mandatory parameters.",
  "Подборка отправлена": "Shortlist sent",
  "Отправили сравнение районов и краткий вывод по каждому варианту.": "A neighborhood comparison and a brief conclusion for each option were sent.",
  "Омар уточнил комфортный платежный план и исключил объекты с жесткими условиями оплаты.": "Omar clarified the comfortable payment plan and excluded properties with rigid payment terms.",
  "В карточке клиента обновлены требования к первому взносу, рассрочке и срокам сдачи объекта.": "The client card was updated with requirements for the down payment, installment plan, and handover timeline.",
  "Следующая активная задача — подтвердить время просмотра по подходящим вариантам.": "The next active task is to confirm the viewing time for the suitable options.",
  "Требования уточнены": "Requirements clarified",
  "Обновили параметры первого взноса, рассрочки и срока сдачи.": "The down payment, installment plan, and handover parameters were updated.",
  "Краткое резюме отправлено": "Brief summary sent",
  "Отправили клиенту подтверждение обновленных условий поиска.": "A confirmation of the updated search criteria was sent to the client.",
  "Другое": "Other",
  "Клиент интересуется апартаментами в JVC и хочет сравнить сроки сдачи и условия оплаты перед тем, как записаться на просмотр.": "The client is interested in apartments in JVC and wants to compare handover dates and payment terms before scheduling a viewing.",
  "Омар ждет короткое сообщение с условиями по подходящим объектам в JVC.": "Omar is waiting for a short message with the terms for the suitable properties in JVC.",
  "Нужно собрать условия оплаты, сроки сдачи и ключевые ограничения по 2–3 объектам, которые подходят под его бюджет.": "You need to gather the payment terms, handover dates, and key limitations for 2-3 properties that fit his budget.",
  "После отправки зафиксируйте реакцию клиента и договоритесь о просмотре или следующем звонке.": "After sending, record the client's reaction and agree on a viewing or the next call.",
  "Майкл запросил варианты вилл в Arabian Ranches с приватным садом и готовностью к заселению. После первой подборки нужно уточнить, готов ли он расширить бюджет ради лучшей локации.": "Michael requested villa options in Arabian Ranches with a private garden and move-in readiness. After the first shortlist, you need to clarify whether he is ready to expand the budget for a better location.",
  "На звонке подтвердить бюджетный диапазон, сроки переезда, обязательные требования к участку и готовность рассматривать соседние комьюнити, если подходящих вилл мало.": "On the call, confirm the budget range, relocation timeline, mandatory plot requirements, and readiness to consider nearby communities if suitable villas are limited.",
  "После разговора обновить критерии поиска и поставить следующую задачу на подбор объектов или организацию просмотра.": "After the conversation, update the search criteria and create the next task for property selection or arranging a viewing.",
  "Звонок завершен": "Call completed",
  "Подтвердили условия оплаты и исключили неподходящие варианты.": "The payment terms were confirmed and unsuitable options were excluded.",
  "Эмма подбирает объект для релокации команды. Важны транспортная доступность, готовность объекта и быстрый просмотр.": "Emma is selecting a property for team relocation. Transport access, property readiness, and a quick viewing are important.",
  "Подготовить": "Prepare",
  "Просмотр": "Viewing",
  "Созвон": "Call",
  "Связаться": "Contact",
...
const setupSteps = [
  {
    ...
    icon: "call-outline",
    eyebrow: "Шаг 1 из 4",
    titleLines: ["Подключите", "звонки"],
    description: "Чтобы анализировать разговоры, обновлять карточки клиентов и не терять важные договоренности.",
    benefitItems: ["Фиксация звонков по клиентам", "Анализ речи и summary после разговора", "Автоматическое обновление задач"],
    primaryLabel: "Подключить звонки",
    secondaryLabel: "Позже",
    modalTitle: "Разрешить доступ к звонкам?",
    modalDescription: "CallGear будет использовать доступ к звонкам, чтобы анализировать разговоры и обновлять данные по клиентам.",
  ...
  },
  {
    ...
    eyebrow: "Шаг 2 из 4",
    titleLines: ["Подключите", "чаты"],
    description: "Чтобы учитывать переписку с клиентами в общей истории коммуникаций и держать все договоренности в одном месте.",
    benefitItems: ["История диалогов рядом с задачами", "Выделение важных договоренностей", "Полный контекст по клиенту"],
    primaryLabel: "Подключить чаты",
    secondaryLabel: "Позже",
    modalTitle: "Разрешить доступ к чатам?",
    modalDescription: "CallGear будет использовать доступ к чатам, чтобы собирать переписку по клиентам и добавлять ее в общую историю.",
    confirmLabel: "Разрешить",
  },
  {
    id: "notifications",
    ...
    eyebrow: "Шаг 3 из 4",
    titleLines: ["Включите", "уведомления"],
    description: "Чтобы получать утренний дайджест, напоминания о задачах и важные обновления по клиентам.",
    benefitItems: ["Утренний дайджест на день", "Напоминания о встречах и созвонах", "Сигналы по просроченным задачам"],
    primaryLabel: "Включить уведомления",
    secondaryLabel: "Позже",
    modalTitle: "Разрешить уведомления?",
    modalDescription: "CallGear будет присылать утренний дайджест, напоминания о задачах и важные обновления по клиентам.",
    confirmLabel: "Разрешить",
  },
  {
    id: "contacts",
    icon: "people-outline",
    eyebrow: "Шаг 4 из 4",
    titleLines: ["Синхронизируйте", "контакты"],
    description: "Чтобы быстрее добавлять клиентов и не заводить их вручную при первом касании.",
    benefitItems: ["Быстрое создание клиентов", "Поиск по уже сохраненным контактам", "Меньше ручного ввода"],
    primaryLabel: "Синхронизировать",
    secondaryLabel: "Пропустить",
    modalTitle: "Разрешить доступ к контактам?",
    modalDescription: "CallGear сможет подгрузить ваши контакты, чтобы вы быстрее создавали клиентов и не вводили данные вручную.",
    confirmLabel: "Разрешить",
  },
];
...
function getSetupStepIndex(routeParam = "1") {
  const step = Number.parseInt(String(routeParam || "1"), 10);
  const safeStep = Number.isFinite(step) ? step : 1;
  return Math.min(Math.max(safeStep, 1), setupSteps.length);
}

function getDefaultSetupPermissions() {
  return {
    calls: false,
    chats: false,
    notifications: false,
  ...
  return `
    <div class="cg-setup-progress" aria-label="Прогресс настройки">
      ${setupSteps
        .map(
          (_, index) => `
            <span class="cg-setup-progress-dot${index + 1 <= currentStep ? " is-active" : ""}" aria-hidden="true"></span>
          `,
        )
        .join("")}
    </div>
...
function renderSetupPermissionModal(step) {
  return `
    <div class="cg-alert-modal" data-setup-permission-modal hidden>
      <section class="cg-alert cg-alert--side-by-side cg-alert--brand" role="alertdialog" aria-modal="true" aria-labelledby="setup-permission-title" aria-describedby="setup-permission-description">
        <span class="cg-alert-blur" aria-hidden="true"></span>
        <span class="cg-alert-bg" aria-hidden="true"></span>
        <span class="cg-alert-glass-effect" aria-hidden="true"></span>
        <div class="cg-alert-copy">
          <h2 class="cg-alert-title" id="setup-permission-title">${escapeHtml(step.modalTitle)}</h2>
          <p class="cg-alert-description" id="setup-permission-description">${escapeHtml(step.modalDescription)}</p>
        </div>
        <div class="cg-alert-actions">
          <button class="cg-content-button cg-content-button--secondary cg-alert-action" type="button" data-setup-modal-cancel>
            <span class="cg-content-button-label">Не сейчас</span>
          </button>
          <button class="cg-content-button cg-content-button--brand cg-alert-action" type="button" data-setup-modal-confirm>
...
function renderSetupApp(routeParam = "1") {
  const currentStep = getSetupStepIndex(routeParam);
  const step = setupSteps[currentStep - 1];

  return `
    <main class="cg-app cg-app--setup">
      <section class="cg-mobile-web-page cg-mobile-web-page--setup" aria-label="Первоначальная настройка">
        <div class="cg-mobile-web-content cg-mobile-web-content--setup">
          <div class="cg-setup-stage">
            <div class="cg-setup-topbar">
              <span class="cg-setup-eyebrow">${escapeHtml(step.eyebrow)}</span>
              ${renderSetupProgress(currentStep)}
            </div>
            <div class="cg-setup-hero">
              <div class="cg-setup-icon-wrap" aria-hidden="true">
                ${renderIonIcon(step.icon, { className: "cg-setup-icon" })}
              </div>
            </div>
            <div class="cg-setup-copy">
              <h1 class="cg-setup-title">
                ${step.titleLines.map((line) => `<span class="cg-setup-title-line">${escapeHtml(line)}</span>`).join("")}
              </h1>
              <p class="cg-setup-description">${escapeHtml(step.description)}</p>
            </div>
            <div class="cg-setup-benefits" aria-label="Что будет доступно">
              ${step.benefitItems
                .map(
                  (item) => `
                    <div class="cg-setup-benefit">
                      <span class="cg-setup-benefit-dot" aria-hidden="true"></span>
                      <span class="cg-setup-benefit-label">${escapeHtml(item)}</span>
                    </div>
                  `,
                )
                .join("")}
          ...
          <div class="cg-setup-footer">
            ${renderButton({
              content: "text",
              style: "filled",
              tone: "primary",
              label: step.primaryLabel,
              className: "cg-setup-primary",
              buttonType: "button",
            }).replace("<button", `<button data-setup-allow="${escapeHtml(step.id)}"`)}
            ${renderButton({
              content: "text",
              style: "ghost",
              tone: "secondary",
              label: step.secondaryLabel,
              className: "cg-setup-secondary",
              buttonType: "button",
            }).replace("<button", `<button data-setup-skip="${escapeHtml(step.id)}"`)}
          </div>
          ${renderSetupPermissionModal(step)}
        </div>
      </section>
    </main>
  `;
    ...
    activities: [
      {
        ...
        title: "Звонок",
        subtitle: "",
        time: "14 марта 2026 с 12:20 по 14:30",
      },
      {
        icon: "chatbubble-ellipses-outline",
        tone: "orange",
      ...
      },
      {
        ...
        title: "Звонок",
        subtitle: "",
        time: "13 марта 2026 с 12:20 по 14:30",
      },
      {
        icon: "call-outline",
        tone: "green",
...
function saveSetupProgress(partialState = {}) {
  const auth = getAuthState();
  const currentPermissions = { ...getDefaultSetupPermissions(), ...(auth.setupPermissions || {}) };
  const nextPermissions = partialState.setupPermissions
    ? { ...currentPermissions, ...partialState.setupPermissions }
    : currentPermissions;

  saveAuthState({
    ...auth,
    ...partialState,
    setupPermissions: nextPermissions,
  });
}
...
function formatTouchDateLabel(date = new Date()) {
  const months = getTouchMonths();
...
function formatTimePart(date = new Date()) {
  const hours = String(date.getHours()).padStart(2, "0");
  const minutes = String(date.getMinutes()).padStart(2, "0");
  return `${hours}:${minutes}`;
}

function formatCallTouchTime(date = new Date(), durationMinutes = 10) {
  const start = new Date(date);
  const end = new Date(date.getTime() + durationMinutes * 60000);
  return `${formatTouchDateLabel(start)} с ${formatTimePart(start)} по ${formatTimePart(end)}`;
}

function formatChatTouchTime(date = new Date(), durationDays = 1) {
  const start = new Date(date);
  ...
  return `С ${startDay} по ${endDay} ${endMonth} ${endYear}`;
}
...
function addClientChatTouch(clientId = "", time = formatChatTouchTime()) {
  if (!clientId) {
    return null;
  }
...
function getClientHasActiveTasksRank(client) {
  return getClientActiveTaskRows(client.id).length > 0 ? 0 : 1;
}
...
function renderAlert(variant) {
  ...
  return `
    <section class="cg-alert cg-alert--side-by-side cg-alert--${tone}" role="alertdialog" aria-labelledby="alert-title" aria-describedby="alert-description">
      <span class="cg-alert-blur" aria-hidden="true"></span>
      <span class="cg-alert-bg" aria-hidden="true"></span>
      <span class="cg-alert-glass-effect" aria-hidden="true"></span>
      <div class="cg-alert-copy">
  ...
  const sheetMarkup = `
    <section class="${pickerClass}" role="dialog" aria-modal="true" aria-labelledby="date-time-picker-title"${pickerMode}${explicitSave ? ' data-picker-explicit-save="true"' : ""}>
      <div class="cg-select-sheet-toolbar cg-picker-toolbar">
        <div class="cg-select-sheet-grabber" aria-hidden="true"><span></span></div>
        <div class="cg-select-sheet-heading cg-picker-heading">
          ${renderIconButton({ style: "secondary", icon: "close-outline", label: "Закрыть без сохранения", className: "cg-picker-toolbar-action" }).replace("<button", '<button data-picker-cancel')}
          <h2 class="cg-select-sheet-title" id="date-time-picker-title">Дата</h2>
          ${renderIconButton({ style: "primary", icon: "checkmark-outline", label: "Подтвердить дату", className: "cg-picker-toolbar-action" }).replace("<button", '<button data-picker-confirm')}
        </div>
      </div>
  ...
  const sheetMarkup = `
    <section class="${sheetClass}" role="dialog" aria-modal="${inline ? "false" : "true"}" aria-labelledby="time-wheel-title"${modalAttr} data-time-wheel-sheet data-time-wheel-mode="${escapeHtml(mode)}">
      ...
      <div class="cg-time-wheel-body cg-time-wheel-body--ionic">
        ...
        ></ion-datetime>
        <button class="cg-content-button cg-content-button--brand cg-content-button--full cg-time-wheel-confirm" type="button" data-time-wheel-confirm>
          <span class="cg-content-button-label">Выбрать</span>
        </button>
      </div>
    </section>
  `;
...
function getClientDetail(clientId = "omar") {
  ...
  const clientDescription = String(baseClient.description || "").trim();
  const sourceSummaryPrice = String(detail?.summary?.price || "").trim();
  const clientPrice = String(baseClient.price || "").trim();
  const normalizedClientPrice = clientPrice || (sourceSummaryPrice && sourceSummaryPrice !== "Без бюджета" ? sourceSummaryPrice : "-");
  const source = detail || {
    summary: {
      description: clientDescription || "-",
      price: normalizedClientPrice,
    ...
    activities: [
      {
        ...
        time: "14 марта 2026 с 12:00 по 12:10",
      },
    ],
  };
  ...
  return {
    ...
    summary: {
      ...source.summary,
      description: clientDescription || source.summary.description || "-",
      price: normalizedClientPrice,
...
function renderNoticeStorybookControls({ tone, size, title, action }) {
  const supportsVariants = size !== "compact";
...
function bindSetupApp(routeParam = "1") {
  const root = document.querySelector(".cg-app--setup");
  const modal = root?.querySelector("[data-setup-permission-modal]");
  const cancelButton = modal?.querySelector("[data-setup-modal-cancel]");
  const confirmButton = modal?.querySelector("[data-setup-modal-confirm]");
  const currentStep = getSetupStepIndex(routeParam);
  const step = setupSteps[currentStep - 1];

  if (!root || !modal || !cancelButton || !confirmButton || !step) {
    return;
  }

  const goToNextStep = () => {
    if (currentStep >= setupSteps.length) {
      saveSetupProgress({ setupCompleted: true });
      window.location.hash = "#/clients";
      return;
    }

    window.location.hash = `#/setup/${String(currentStep + 1)}`;
  };
  ...
  root.querySelector("[data-setup-allow]")?.addEventListener("click", () => {
    setModalOpen(true);
  });

  root.querySelector("[data-setup-skip]")?.addEventListener("click", () => {
    goToNextStep();
  });
...
function bindCallProgressModal(root = document) {
  ...
  chatFinishButton?.addEventListener("click", () => {
    ...
    const currentTouchTime = formatChatTouchTime();
...
function bindTimeWheelPicker(root = document) {
  ...
  const confirmButton = sheet?.querySelector("[data-time-wheel-confirm]");
  if (!sheet || !ionicPicker || !confirmButton) {
    return;
  }
  ...
  let draftStart = currentStart;
  let draftEnd = currentEnd;
  ...
  const configurePicker = ({ mode = "single", start = "07:10", end = "07:30", startKey = "", endKey = "" } = {}) => {
    ...
    ionicPicker.value = formatIonicTimePickerValue(draftStart);
    setPickerOpen(true);
  };
  ...
  ionicPicker.addEventListener("ionChange", (event) => {
    draftStart = parseIonicTimePickerValue(event.detail?.value || ionicPicker.value || "", draftStart);
  });

  confirmButton.addEventListener("click", () => {
    currentStart = draftStart;
    currentEnd = draftEnd;
...
function bindDateTimePicker(form) {
  ...
  const cancelButton = form.querySelector("[data-picker-cancel]");
  const confirmButtons = Array.from(form.querySelectorAll("[data-picker-confirm], [data-picker-save]"));
  ...
  const timeWheelConfirmButton = timeWheelSheet?.querySelector("[data-time-wheel-confirm]");
  ...
  let timeWheelDraftValue = timeWheelValue;

  if (!timeInput || !timeTrigger || !timeValue || !picker || !pickerBody || !scrim || (!isInline && !pickerModal) || !calendarSlot || !clearButton || !cancelButton || !confirmButtons.length || !timeToggle || !endToggle || !startRow || !endRow || !startDateField || !startTimeField || !endDateField || !endTimeField) {
    return;
  }
  ...
  const createPickerSnapshot = () => ({
    selectedDate: new Date(selectedDate),
    endDate: new Date(endDate),
    startTime: parsePickerTimeText(startTimeField.value || "14:00", "14:00"),
    endTime: parsePickerTimeText(endTimeField.value || "15:00", "15:00"),
    includeTime,
    includeEnd,
    isEmpty,
  });
  ...
  let committedState = {
    selectedDate: new Date(selectedDate),
    endDate: new Date(endDate),
    startTime: parsedInitialValue.start.time || startTimeField.value || "14:00",
    endTime: parsedInitialValue.end.time || endTimeField.value || "15:00",
    includeTime,
    includeEnd,
    isEmpty,
  };

  const restorePickerSnapshot = (snapshot) => {
    selectedDate = new Date(snapshot.selectedDate);
    endDate = new Date(snapshot.endDate);
    includeTime = Boolean(snapshot.includeTime);
    includeEnd = Boolean(snapshot.includeEnd);
    isEmpty = Boolean(snapshot.isEmpty);
    startDateField.value = formatPickerDate(selectedDate);
    startTimeField.value = snapshot.startTime;
    endDateField.value = formatPickerDate(endDate);
    endTimeField.value = snapshot.endTime;
  ...
  const resetDraftState = () => {
    restorePickerSnapshot(committedState);
    activeEndpoint = includeEnd ? activeEndpoint : "start";
    syncToggles();
    renderCalendar();
  };
  ...
  const openTimeWheel = (field) => {
    ...
    timeWheelDraftValue = timeWheelValue;
    timeWheelIonicPicker.value = formatIonicTimePickerValue(timeWheelDraftValue);
  ...
  const syncDraftFields = () => {
    startDateField.value = formatPickerDate(selectedDate);
    startTimeField.value = getStartTime();
    endDateField.value = formatPickerDate(endDate);
    endTimeField.value = getEndTime();
  };

  const commitValue = ({ syncFields = true, closeAfterCommit = true } = {}) => {
    validateEndValue();
    ...
    committedState = createPickerSnapshot();
  ...
  timeWheelIonicPicker?.addEventListener("ionChange", (event) => {
    timeWheelDraftValue = parseIonicTimePickerValue(event.detail?.value || timeWheelIonicPicker.value || "", timeWheelDraftValue);
  });

  timeWheelConfirmButton?.addEventListener("click", () => {
    timeWheelValue = timeWheelDraftValue;
  ...
  timeWheelModal?.addEventListener("click", (event) => {
    if (event.target === timeWheelModal || event.target?.hasAttribute("data-time-wheel-close")) {
      timeWheelDraftValue = timeWheelActiveField === "end" ? getEndTime() : getStartTime();
      if (timeWheelIonicPicker) {
        timeWheelIonicPicker.value = formatIonicTimePickerValue(timeWheelDraftValue);
      }
      setTimeWheelOpen(false);
    }
  ...
  if (isEmpty) {
    ...
    commitValue({ closeAfterCommit: false });
  }
}
